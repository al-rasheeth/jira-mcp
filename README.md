...
| `JIRA_MAX_RESULTS_LIMIT` | No | `100` | Max value for `maxResults` in tools/prompts (1–1000). JIRA Cloud search returns at most 100 per request; the client paginates automatically to fetch up to this limit. |
